<h2> 378 98
2901. Longest Unequal Adjacent Groups Subsequence II</h2><hr><div><p>You are given a string array <code>words</code>, and an array <code>groups</code>, both arrays having length <code>n</code>.</p>
