<h2> 412 42
2918. Minimum Equal Sum of Two Arrays After Replacing Zeros</h2><hr><div><p>You are given two arrays <code>nums1</code> and <code>nums2</code> consisting of positive integers.</p>
